 ...
 *
 * @package c2c_BlogTime_Widget_011
 * @author  Scott Reilly
 * @version 011
 */
...
if ( class_exists( 'WP_Widget' ) && ! class_exists( 'c2c_BlogTime_Widget_011' ) ) :

class c2c_BlogTime_Widget_011 extends WP_Widget {
...
//					echo "<h5>$label</h5>";
	 ...
	 *
	 * e.g.
	 *   $this->title = __( 'My Plugin Widget', 'blog-time' );
...
} // end class c2c_BlogTime_Widget_011
