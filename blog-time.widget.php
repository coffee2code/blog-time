...
class BlogTimeWidget extends WP_Widget {
	...
	var $title = 'Blog Time';
	var $description = 'The time according to your blog.';
	var $config = array(
		...
		'title' => array('input' => 'text', 'default' => 'Blog Time',
				'label' => 'Title'),
		'format' => array('input' => 'text', 'default' => 'g:i A',
				'label' => 'Time format',
				'help' => 'PHP-style time format string. See <a href="http://php.net/date" title="">http://php.net/date</a> for more info.'),
		'before' => array('input' => 'text', 'default' => '',
				'label' => 'Before text',
				'help' => 'Text to display before the time.'),
		'after' => 	array('input' => 'text', 'default' => '',
				'label' => 'After text',
				'help' => 'Text to display after the time.')
	);
	var $defaults = array();
	...
	function BlogTimeWidget() {
		...
		$widget_ops = array( 'classname' => 'widget_' . $this->widget_id, 'description' => __($this->description) );
